...
public class MusicPlaylistDetailAdapter extends BaseAdapter {
    private Context context;
    private ArrayList<MusicFile> list_song;

    MusicPlaylistDetailAdapter(Context mcontex, ArrayList<MusicFile> mFiles) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("sender","PlaylistDetail");
